...
function! s:MapGitOps(is_ftplugin) abort
  ...
  exe s:Map('n', 'cff', ':<C-U>Git commit --fixup=<C-R>=<SID>SquashArgument()<CR>', '', ft)
  exe s:Map('n', 'cfa', ':<C-U>Git commit --fixup=amend:<C-R>=<SID>SquashArgument()<CR>', '', ft)
  exe s:Map('n', 'cfr', ':<C-U>Git commit --fixup=reword:<C-R>=<SID>SquashArgument()<CR>', '', ft)
